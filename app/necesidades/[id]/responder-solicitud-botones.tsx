...
import { responderSolicitud, type ResponderSolicitudState } from './solicitar-actions'
...
// para el autor de la necesidad, en solicitudes aun PENDIENTES: una vez
...
export function ResponderSolicitudBotones({ solicitudId }: { solicitudId: string }) {
  const [state, formAction, isPending] = useActionState(responderSolicitud, ESTADO_INICIAL)
