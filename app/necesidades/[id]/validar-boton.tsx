...
import { validarNecesidad, type ValidarState } from './validar-actions'
...
export function ValidarBoton({ necesidadId }: { necesidadId: string }) {
  const [state, formAction, isPending] = useActionState(validarNecesidad, ESTADO_INICIAL)
